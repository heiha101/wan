...
$(function(){
                ...
                function showDate(yyyy,mm){
                    ...
                    $.ajax({
                        url:'http://127.0.0.1/01203qiandao/frontend/web/index.php?r=check/show1',
                        dataType:'json',
...
$(document).on('click','.f-day',function(){
    ...
    if(logday>newday){
        ...
        if($(this).parent().find("#aa").attr('class')!= ''){
            ...
            if(con == true){
                $.ajax({
                    url:'http://127.0.0.1/01203qiandao/frontend/web/index.php?r=check/bu',
                    data:{logday:logday},
                    type:'get',
                    dataType:'json',
                    success:function(msg){
        ...
        if($(this).parent().find("#aa").attr('class')!= ''){
            ...
            $.ajax({
            url:'http://127.0.0.1/01203qiandao/frontend//web/index.php?r=check/fen',
            data:{newday:newday},
            type:'get',
            dataType:'json',
            success:function(msg){
    ...
    if(date[2]==daysCount){
        $.ajax({
            url:'http://127.0.0.1/01203qiandao/frontend//web/index.php?r=check/di',
