    ...
    <div id="header">
        <div class="wrapper">
            ...
            <ul class="reset" id="navheader">
                <li class="current"><a href="<?= Urlservice::buildMUrl('/default/index')?>">首页</a></li>
        ...
        <div class="clearfix">
            ...
            <div class="content_l">
                <div class="c_detail">
                            ...
                            <div id="logoShow">
                                <img id="com_logo" src="/<?= $data['f_logo']?$data['f_logo']:'style/images/logo_default.png'?>" width="190" height="190" alt="公司logo" />
                                <span>更换公司图片<br />190px*190px 小于5M</span>
                            </div>
                             <input type="hidden" id="img_url" value="<?= Urlservice::buildMUrl('/comindex/logo-save')?>"/>
                            <input type="file" id="logo" name="logo" title="支持jpg、jpeg、gif、png格式，文件小于5M" />
                        </div>
                    ...
                    <script>
                        $(document).on('change','#logo',function(){
                            ...
                            form.append('f_logo',obj[0].files[0]);
                            $.ajax({
                                url:url,
                                data:form,
                                type:'post',
                                ...
                                success:function(msg){
                                    ...
                                    $('#com_logo').prop('src',"<?= Urlservice::buildWwwUrl('/"+msg+"')?>");
                                }
                            })
                        })
                    </script>
                    <div class="c_box companyName">
                        <h2 title="<?= $data['f_name']?>" id="f_name"><?= $data['f_name']?></h2>
                        ...
                        <form class="clear editDetail dn" id="editDetailForm">
                            <input type="text" placeholder="请输入公司简称" maxlength="15" value="<?= $data['f_name']?>" name="companyShortName" id="f_names">
                            <input type="text" placeholder="一句话描述公司优势，核心价值，限50字" maxlength="50" value="<?= $data['f_introduce']?>" name="companyFeatures" id="f_introduces">
                            <input type="button" value="保存" id="savet" data-content="<?= Urlservice::buildMUrl('/comindex/name-save')?>" class="my_btn">
                            <a id="cancelDetail" class="btn_cancel_s" >取消</a>
                        </form>

                        <div class="clear oneword"><img width="17" height="15" src="style/images/quote_l.png">&nbsp; <span id="f_introduce"><?= $data['f_introduce']?></span> &nbsp;<img width="17" height="15" src="style/images/quote_r.png"></div>
                        <h3 class="dn" id="boon_h3">已选择标签</h3>
                        <ul style="overflow:auto" id="hasLabels" class="reset clearfix">
                            <?php if($boon_arr){?>
                             <?php foreach($boon_arr as $k=>$v):?>
                                        <li><span id="<?= $v['boon_id']?>"><?= $v['boon_name']?></span></li>
                            <?php endforeach ?>
                            <?php }?>
                            <li class="link">编辑</li>
                        </ul>
                        <div class="dn" id="addLabels">
                            ...
                            <input type="hidden" value="<?= Urlservice::buildMUrl('/comindex/up_boon')?>" id="boon_url"/>
                            <input type="hidden" value="<?= Urlservice::buildMUrl('/comindex/del_boon')?>" id="boon_del_url"/>
                            <a id="saveLabels" class="btn_small btn_boon" href="javascript:void(0)">保存</a>
...
<script src="<?= Urlservice::buildWwwUrl('/style/js/com_ajax.js')?>" type="text/javascript"></script>
