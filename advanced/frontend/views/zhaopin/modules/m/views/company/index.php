                    ...
                    <dl class="hc_tag">
                        ...
                        <ul class="workplace reset fr" id="workplaceSelect">
                            ...
                            <?php foreach($res as $k=>$v) { ?>
                                <li >
                                <a href="company/region/<?= $v['r_id']?>" ><?= $v['r_name']?></a>
                                |
                            </li>
                            <?php }?>
                            <li >
                        ...
                        <dd>
                            <dl>
                                <dt>发展阶段：</dt>
                                <dd>
                                    <a href="javascript:void(0)" value="0">初创型</a>
                                    <a href="javascript:void(0)" value="1">成长型</a>
                                    <a href="javascript:void(0)" value="2">成熟型</a>
                                    <a href="javascript:void(0)" value="3">已上市</a>
                                </dd>
                            </dl>
                            <dl>
                                <dt>行业领域：</dt>
                                <dd>
                                    <?php foreach($reg as $key => $value) {?>
                                        <a href="javascript:void(0)"><?php echo $value['i_name']?></a>
                                    <?php } ?>
                                </dd>
                            </dl>
                            <!-- <dl>
                    ...
                    <ul class="hc_list reset">
                        ...
                        <li >
                            <a href="h/c/25836.html" target="_blank">
                                <h3 title="<?= $value['f_id']?>"><?= $value['f_name']?></h3>
                                <div class="comLogo">
                                    <img src="<?= $value['f_logo']?>" width="190" height="190" alt="MOMO" />
                                    <ul>
<!--                                        --><?php //foreach($value['i_name'] as $k=>$v):?>
                                        <li><?= implode(',',$value['i_name'])?></li>
<!--                                        --><?// endforeach ?>
                                        <li><?= $value['r_name']?>,<?= $value['e_stage']?></li>
                                    </ul>
                                </div>
                            </a>
            ...
            <div class="content_r">
                <div class="subscribe_side">
                    <a href="subscribe.html" target="_blank">
                        ...
                        <i><a href="<?= \app\common\services\Urlservice::buildMUrl('/company/subscribe')?>">我也要订阅职位</a></i>
                    </a>
                </div>
