...
<body id="login_bg">
	<div class="login_wrapper">
		...
		<div class="login_box">
        	<form id="loginForm" action="<?= Urlservice::buildMUrl('/login/register')?>" method="post">
            	...
            	<input type="text" id="u_email" name="u_email" tabindex="1" placeholder="请输入常用邮箱地址" />
            ...
            <div class="login_right">
            	<div>已有拉勾帐号</div>
            	<a  href="<?php echo Urlservice::buildWwwUrl('login/login')?>"  class="registor_now">直接登录</a>
